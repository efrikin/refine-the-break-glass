...
## Conversation between SSH and NSS[^nss] {background-gradient="linear-gradient(to bottom, #00192C, #004F61)"}
...
## Conversation between sshd, NSS and PAM[^pam-module] {background-gradient="linear-gradient(to bottom, #00192C, #004F61)" style="font-size: 80%;"}
